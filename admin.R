...
# - At Posit Cloud update the Tools for Analytics (template) workspace (R and packages)
# - Make a copy of the workspace and change all links on lines 61-70 in link.md
