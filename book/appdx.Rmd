...
Below you can see the current help queue for study café time-slots (refresh you browser window may be a good idea). If it is empty the TAs have nothing to do ... so ask some questions :-) 
