...
We all get stuck sometimes and need some help. Below are some advises on how to help yourself and ask for help:
  ...
  * First try to understand the error message and solve the problem. You may try to debug your code by inserting `browser()` in your code. See [Chapter 11][debug-in-r] in @wtf for further details.  
...
Slides from the on-line lectures.

* [Welcome to TFA][slides-welcome].
* [Module 1-3][slides-m1-3] - [R-scipt file](https://github.com/bss-osca/tfa/blob/master/slides/01-r_part_welcome/01-welcome_r_part.R).
* [Module 4-5][slides-m4-5] - [R-scipt file](https://github.com/bss-osca/tfa/blob/master/slides/02-programming/02-programming.R).
* [Module 6-8][slides-m6-8] - [R Markdown file](https://github.com/bss-osca/tfa/blob/master/slides/03-transform/03-transform_examples.Rmd).
