...
If you are not allowed to read the data into an array using the course procedure `AryRead`, but only plain VBA you must use for loop(s) to assign values to the array:
