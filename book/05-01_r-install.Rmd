...
In the learning path diagram, there may be links to alternative online content will be pointed out. Note this is an alternative to the standard learning path that you may use instead. The learning path may also have extra content that is not a part of syllabus you can have a look at. We are all different and you may like different learning styles compared to others. 
...
<!-- * Installed Git. -->
* Signed up on RStudio cloud and tested it. 
...
* Join the Tools for Analytics workspace on [RStudio Cloud][rstudio-cloud] (signup if you have not done it yet).
* Click the _Projects_ link (top menu) and open the project _00-module-11_. A personal copy of the project is loaded for you.
