...
You may also have a look at the [slides for this module](https://bss-osca.github.io/tfa/slides/05-02_r-workflow-slides.html#11).
...
Practice using shortcuts in RStudio (use Shift+Alt+K to get an overview). [Link to the project for this module][r-cloud-mod12]. 
