...
### Exercise (OneCom) {#ex-r-onecom}

Consider the case [OneCom](https://bss-osca.github.io/osca/cases/onecom-case.pdf) and read the introduction, Section 1 and Section 2. Next, read Section 5 and answer the questions. Data can be found at [GitHub](https://github.com/bss-osca/osca/tree/main/docs/cases/onecom-case-data) (download the raw files).
...
Moreover, give an answer to Question 5:
  ...
  5) Discuss how assumptions and data validation may affect how the numbers in Table 1 is estimated. May this affect the result in redesigning the supply chain network given the merger in \autoref{sec:merger}? How can the challenges be addressed? 
