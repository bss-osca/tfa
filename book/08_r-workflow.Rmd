...
A template project for this module is given on [RStudio Cloud][r-cloud-mod8] (open it and use it while reading the notes).
...
Launch [RStudio Cloud][r-cloud-mod8] (follow this link to get to the correct project). An personal copy of the project is now created for you. Consider the panes:
