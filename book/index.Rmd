...
The learning outcomes relate to the [overall learning goal](#lg-course) number 1, 3 and 5 of the course.
...
Module \@ref(sec-intro) (this module) gives a short introduction to the book. Next, the book consists of different parts each containing teaching modules about specific topics:
   ...
   * [Part I](#sec-vba-intro) Gives you an introduction to VBA and how to program it in Excel.
