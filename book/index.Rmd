...
Module \@ref(sec-intro) (this module) gives a short introduction to the book. Next, the book consists of different parts each containing teaching modules about specific topics:
   ...
   * [Part I](#sec-install) focus on helping you install the needed programs on your computer (Module \@ref(sec-install)) and give you a short introduction to R (Module \@ref(sec-r-basics)).
   ...
   * [Part III](#sec-tidy-intro) the focus is on import/export, tidy and transformation of data. Module \@ref(sec-tidy-intro) first gives you an introduction to the [tidyverse][tidyverse-main-page] packages and introduce you to literal programming using R Markdown. Next, Module \@ref(sec-io) shows you how to export and import data. Finally, Module \@ref(sec-transform) focus on transformation of data.
...
Also thanks to Solveig for proofreading the draft. I would like to thank all for their inspiration. This work is licensed under the Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/).
