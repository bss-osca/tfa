...
< More to come >   
   ...
   <!-- * [Part I](#mod-install) focuses on helping you install the needed programs on your computer (Module \@ref(mod-install)) and gives you a short introduction to R (Module \@ref(mod-r-basics)). -->
   <!-- * [Part II](#mod-loops) gives you an overview over programming in R including loops and conditionals (Module \@ref(mod-loops)) and functions (Module \@ref(mod-functions)). -->
   <!-- * [Part III](#mod-tidy-intro) the focus is on import/export, tidy and transformation of data. Module \@ref(mod-tidy-intro) first gives you an introduction to the [tidyverse][tidyverse-main-page] packages and introduces you to literal programming using R Markdown. Next, Module \@ref(mod-io) shows you how to export and import data. Finally, Module \@ref(mod-transform) focuses on transformation of data. -->
   <!-- * [Part IV](#mod-plot) considers visualization of data in R (Module \@ref(mod-plot)).  -->
   <!-- * [Part V](#mod-project) presents your mandatory R project. -->
   <!-- * [Part VI](#mod-r-excel) contains extra modules not part of the curriculum in this course. But it may be useful during your study. -->
...
* Module \@ref(mod-install) is inspired by [Chapter 1](https://stat545.com/block000_r-rstudio-install.html) in @stat545.
* Module \@ref(mod-r-basics) is using some text and images from [Chapter 1](https://moderndive.netlify.app/1-getting-started.html) in @moderndrive and [Chapter 2](https://stat545.com/block002_hello-r-workspace-wd-project.html) in @stat545. A few exercises are inspired by [Chapter 2](https://rafalab.github.io/dsbook/r-basics.html) in @dsbook.
