...
Read Chapter 4 in @vba-book. You may also have a look at the alternative videos instead as listed in the learning path diagram.
...
It is recommended to use keys since using keys is has three advantages:
...
You may also have a look at the [slides for this module](https://bss-osca.github.io/tfa/slides/02-01_vba-datatypes-slices.html).
