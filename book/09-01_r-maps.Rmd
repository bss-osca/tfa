...
# Spatial data and maps {#mod-maps}
...
## Services for obtatining spatial data {#mod-map-api-key}
...
Remember to have [set your API key](#mod-map-api-key) and activate the *Distance Matrix API* service on the Google Cloud Platform. We consider the following places:
