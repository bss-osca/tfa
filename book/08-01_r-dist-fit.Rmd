...
```{r, solution=TRUE, text="For a Poisson process the inter arrival times should follow an exponential distribution."}
library(fitdistrplus)
dat <- calls %>% 
  filter(
    wday == "Tue",
...
```  
  (5) What is the estimated arrival rate per hour Tuesday 12-13 and 16-17? Is the arrival rate the same?
