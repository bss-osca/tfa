...
The package contains templates for exercises etc. Go to **File > New File > R Markdown...**. In the pop-up box select the **From template** in the left column and then **TFA Exercise**. Press *Ok* and a new R Markdown document will be opened. 
