...
Must functions support the pipe operator which are a powerful tool for clearly expressing a sequence of multiple operations. The pipe operator `%>%`, comes from the magrittr package and is loaded automaticaly when you load tidyverse. You may use the RStudio keyboard shortcut: Ctrl+Shift+M (Windows), Cmd+Shift+M (Mac).
...
* Roger Peng has a lot of [videos](https://www.youtube.com/playlist?list=PLjTlxb-wKvXPqyY3FZDO8GqIaWuEDy-Od) on YouTube about R. Of special interest are
   ...
   - A introduction to the R language ([Part 1](https://www.youtube.com/watch?v=vGY5i_J2c-c), [Part 2](https://www.youtube.com/watch?v=w8_XdYI3reU), [Part 3](https://www.youtube.com/watch?v=NuY6jY4qE7I)) including data types and basic operations.
   - [A introduction to subsetting in R](https://www.youtube.com/watch?v=hWbgqzsQJF0&list=PLjTlxb-wKvXPqyY3FZDO8GqIaWuEDy-Od&index=10&t=0s) 
   - 
...
selects the columns related to cylinders, gears, hoursepower and miles, and then rows with cars having four cylinders and gears. 
...
Sometimes it may be usefull to define an empty list with a number of elements
...
creation (and empty list with elements)
