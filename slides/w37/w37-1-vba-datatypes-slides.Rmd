...
Let us try some examples using this [Excel file](https://github.com/bss-osca/tfa/blob/master/vba/vba-variables-template.xlsm) template.
...
Note the default start index is 0. If you want to start with index 1 then add 
  ```
  Option Base 1
  ```
...
Often we don't know the size of the array we need when we start the program.
