...
A definition of all variables/columns is given in the [Data dictionary] section at the end, though you don't need to familiarize yourself with all variables.
...
Columns that contains with "date":
