...
* Please note that the weights on each assignment are only guideline weights, and they only provide information regarding the relative weight of the assignments. The final 
...
* Your R code will be tested using R 4.0.3. As operating system Windows will be used.
...
# We wish you good luck at the exam!
