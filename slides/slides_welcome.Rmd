...
- This course gives you an introduction to different tools which can be used when you perform Analytics.
...
- The schedule will give you an overview over each week.
