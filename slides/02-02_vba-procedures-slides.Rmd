...
A procedure may often be called with the same input argument value. To avoid specifying the value always you may set a default value using the `Optional` keyword:
  ```
...
Let us try to format come cells by running the procedures in module `D_DefaultArgs` in the [Excel file](https://github.com/bss-osca/tfa/blob/master/vba/vba-procedures-template.xlsm).
