...
- You can only run VBA using the desktop version of Excel (not the web version). MS doesn't support VBA in MS 365 (Office 365).
...
- Step 5: Consider the remaining students and create a group by adding students until the group size is 4.
