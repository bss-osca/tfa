...
- You can access RStudio using either: [RStudio Cloud][rstudio-cloud] (follow link to the workspace) or RStudio installed on your laptop (R must also be installed too).
